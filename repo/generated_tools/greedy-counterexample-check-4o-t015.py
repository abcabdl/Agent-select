...
def _call_llm(prompt):
    ...
    system = """You are a greedy algorithm expert. Make optimal local choices.
CRITICAL RULES:
...
5. Write clean, correct code"""
    ...
    user = """Apply greedy strategy to: {prompt}. Explain optimal choice. Return body only."""
...
def run(inputs):
    ...
    try:
        ...
        code = _post_process_greedy(code)
        return {
            "output": {
                "code": code,
