"""
greedy-optimize-local-4o-t16: Greedy algorithm expert: local optimization, choice selection, proof construction, counterexample checking
"""
import os
import httpx
import json
...
def run(inputs):
    ...
    system_prompt = 'You are a greedy algorithm expert. Generate Python code for local optimization strategies. Validate correctness with proofs.'
    
    user_prompt = 'Task: {task}\n\nGenerate highly optimized Python code. Focus on time and space complexity. Explain optimization strategies.'
