"""
graph-topology-sort-4omini-t21: Graph algorithm specialist: BFS, DFS, shortest path, topological sort, cycle detection
"""
import os
import httpx
import json
...
def run(inputs):
    ...
    system_prompt = 'You are a graph algorithm specialist. Generate Python code for graph traversal, shortest path, topological sort, and cycle detection. Use appropriate data structures.'
