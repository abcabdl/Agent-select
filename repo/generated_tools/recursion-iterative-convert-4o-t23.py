"""
recursion-iterative-convert-4o-t23: Recursion optimization master: base case design, tail recursion, stack management, iterative conversion
"""
import os
import httpx
import json
...
def run(inputs):
    ...
    system_prompt = 'You are a recursion optimization expert. Generate Python code with proper base cases, tail recursion where applicable, and iterative alternatives. Handle stack depth carefully.'
