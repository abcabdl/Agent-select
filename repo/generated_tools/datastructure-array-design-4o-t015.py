...
def _post_process_datastructure(code):
    """
    datastructure特定的后处理逻辑
    """
...
def _call_llm(prompt):
    ...
    system = """You are a data structure designer. Create efficient custom structures.
CRITICAL RULES:
...
def run(inputs):
    ...
    try:
        ...
        code = _post_process_datastructure(code)
        return {
            "output": {
                "code": code,
