"""
math-combinatorics-calc-4omini-t12: Mathematical computation expert: number theory, modulo, combinatorics, geometry, precision handling
"""
import os
import httpx
import json
...
def _post_process_math(code: str) -> str:
...
def run(inputs):
    ...
    system_prompt = 'You are a mathematical computation expert. Generate precise Python code for number theory, modulo operations, combinatorics, and geometry.'
