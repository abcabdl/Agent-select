"""
check-validate-errorhandle-4o-t30-v14: Quality checker focusing on errorhandle: validation, verification, edge cases
"""
import os
import httpx
import json
...
def run(inputs):
    ...
    system_prompt = 'You are a quality checker. Generate Python code for validation, verification, and testing.'
