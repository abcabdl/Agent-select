...
def _call_llm(prompt):
    ...
    system = """You are a graph algorithms specialist. Implement traversals and pathfinding.
CRITICAL RULES:
...
5. Handle disconnected graphs"""
    
    user = """Implement graph algorithm for: {prompt}. Handle disconnected graphs. Return body only."""
