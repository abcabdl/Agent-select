"""
module-interface-define-4omini-t67: Module design expert: structure planning, dependency management, interface definition, namespace organization
"""
import os
import httpx
import json
...
def run(inputs):
    ...
    system_prompt = 'You are a module design expert. Plan and structure Python modules with clear dependencies, interfaces, and namespace organization.'
