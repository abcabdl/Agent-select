"""
edgecase-overflow-prevent-4omini-t30: Edge case specialist: boundary validation, null handling, overflow prevention, empty input checks
"""
import os
import httpx
import json
...
def _post_process_edgecase(code: str) -> str:
    """Edge case-specific post-processing"""
    return code
...
def run(inputs):
    ...
    system_prompt = 'You are an edge case validation expert. Generate Python code with comprehensive boundary checks, null handling, and input validation.'
    ...
    # 后处理
    code = _post_process_edgecase(code)
