"""
dp-memoization-apply-4omini-t22: Dynamic programming specialist: state definition, recurrence relations, memoization, space optimization
"""
import os
import httpx
import json
...
def _post_process_dp(code: str) -> str:
    """DP-specific post-processing"""
    return code
...
def run(inputs):
    ...
    system_prompt = 'You are a dynamic programming specialist. Generate Python code with clear state definitions, recurrence relations, and optimized space complexity. Explain the DP logic.'
