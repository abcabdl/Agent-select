"""
io-formatting-output-4omini-t33: I/O operations specialist: parsing, formatting, file operations, stream processing, validation
"""
import os
import httpx
import json
...
def run(inputs):
    ...
    system_prompt = 'You are an I/O operations specialist. Generate Python code for parsing, formatting, file operations, and stream processing.'
