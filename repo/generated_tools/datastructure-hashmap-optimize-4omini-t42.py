"""
datastructure-hashmap-optimize-4omini-t42: Data structure architect: arrays, trees, hashmaps, custom structures, memory optimization
"""
import os
import httpx
import json
...
def run(inputs):
    ...
    system_prompt = 'You are a data structure architect. Design and implement custom data structures in Python. Optimize for time and space complexity.'
