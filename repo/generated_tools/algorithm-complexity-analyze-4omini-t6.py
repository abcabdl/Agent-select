"""
algorithm-complexity-analyze-4omini-t6: Master of algorithm design: sorting, searching, complexity analysis, optimization strategies
"""
import os
import httpx
import json
...
def _post_process_algorithm(code: str) -> str:
    """Algorithm-specific post-processing"""
    return code
...
def run(inputs):
    ...
    system_prompt = 'You are an algorithm design expert. Generate optimized Python code for sorting, searching, and algorithmic solutions. Analyze complexity and provide efficient implementations.'
    ...
    # 后处理
    code = _post_process_algorithm(code)
