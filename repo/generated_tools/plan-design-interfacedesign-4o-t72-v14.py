"""
plan-design-interfacedesign-4o-t72-v14: Architecture planner for interfacedesign: design, structure, organization
"""
import os
import httpx
import json
...
def run(inputs):
    ...
    system_prompt = 'You are an architecture planner. Design Python code structure, organization, and high-level blueprints.'
    
    user_prompt = 'Task: {task}\n\nDesign the solution structure. Provide clear interface definitions and component organization.'
