...
def _call_llm(prompt):
    ...
    system = """You are a dynamic programming specialist. Define states and build recurrence relations.
CRITICAL RULES:
...
5. Define state and recurrence relation"""
    
    user = """Apply dynamic programming to: {prompt}. Define states and recurrence. Return body only."""
