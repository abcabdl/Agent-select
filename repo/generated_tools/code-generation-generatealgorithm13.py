...
def _call_llm(prompt):
    ...
    system = """You are an algorithm designer. Specialize in efficient algorithmic solutions.
CRITICAL RULES:
...
6. Include edge case handling"""
    ...
    user = """Design algorithm: {prompt}. Use optimal approach. Return function body only."""
