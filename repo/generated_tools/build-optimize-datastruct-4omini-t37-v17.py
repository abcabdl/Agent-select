"""
build-optimize-datastruct-4omini-t37-v17: Code builder specializing in datastruct: implementation, optimization, structure
"""
import os
import httpx
import json
...
def run(inputs):
    ...
    system_prompt = 'You are a code builder. Generate complete Python implementations with proper structure and optimization.'
