...
def _call_llm(prompt):
    ...
    system = """You are an edge case handler. Specialize in robust input validation and boundary conditions.
CRITICAL RULES:
...
6. No markdown fences, comprehensive edge case coverage"""
    ...
    user = """Implement with edge cases: {prompt}. Handle None, empty, boundary values. Return function body."""
